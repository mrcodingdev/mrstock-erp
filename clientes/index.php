                            ...
                            <tr class="linha-cliente">
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <?php if ($hasZap): ?>
                                            <a href="https://wa.me/55<?= $zapNum ?>" target="_blank" class="btn-whatsapp" title="Conversar no WhatsApp" aria-label="Conversar no WhatsApp com <?= htmlspecialchars($c['nome']) ?>">
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow border py-2" style="font-size: 0.85rem; border-color: #cbd5e1;">
                                            ...
                                            <?php if ($hasZap): ?>
                                            <li>
                                                <a class="dropdown-item py-1 text-success" href="https://wa.me/55<?= $zapNum ?>" target="_blank">
