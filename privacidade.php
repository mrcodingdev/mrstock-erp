    ...
    <div class="card border-0 shadow-sm rounded-3 mb-4 p-4" style="background: linear-gradient(135deg, #1a4231, #284936); color: #ffffff;">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
            <div>
                ...
                <h1 class="h2 fw-bold mb-1 text-white">Política de Privacidade &amp; Proteção de Dados</h1>
                <p class="mb-0 text-white-50" style="font-size: 0.95rem;">Diretrizes de conformidade, segurança da informação e transparência da Papelaria Real Ltda.</p>
            </div>
